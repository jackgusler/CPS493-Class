...
<template>
  <main class="columns is-multiline is-centered">
    <div class="column is-full">
      ...
      <h2 class="subtitle">Welcome to your Vue.js + TypeScript app</h2>
    </div>
      ...
      <div class="panel is-primary">
        ...
        <p class="panel-tabs">
          <a
            ...
            :class="{ 'is-active': tabState == tab }"
            @click.prevent="tabState = tab"
            >{{ tab }}</a
          >
        </p>
        <label
